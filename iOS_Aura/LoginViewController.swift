...
//        presentLoading("Sign in with Google...")
    ...
    @IBAction func resendConfirmation(_ sender: AnyObject) {
        ...
        if (usernameTextField.text ?? "") == "" {
            ...
            let loginManager = AylaNetworks.shared().loginManager
            let template = AylaEmailTemplate(id: "registeracct-en", subject: "Confirm your email", bodyHTML: nil)
    ...
    @IBAction func resetPassword(_ sender: AnyObject) {
        if (usernameTextField.text ?? "") == "" {
            ...
            let loginManager = AylaNetworks.shared().loginManager
            let template = AylaEmailTemplate(id: "registeracct-en", subject: "Password Reset Request", bodyHTML: nil)
