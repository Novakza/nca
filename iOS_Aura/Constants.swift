...
struct AuraOptions {
    ...
    */
    ...
    static let AppIdUSDev     = "nca-id"
    static let AppSecretUSDev = "nca-kEvg7Qbs5vvdanhb--Mth-cPGOI"
    
    // OEM Dashboard:  https://dashboardField.aylanetworks.com
    // Developer Site: Development on field service is not allowed
    static let AppIdUSField     = "aura_0dfc7900-id"
    static let AppSecretUSField = "aura_0dfc7900-eUo-3Se7R25Z_QLeEiXqYkQDUNA"
